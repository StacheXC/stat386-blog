...
Overall, this was a fun data set to explore. I especially enjoyed providing graphical support for many things I was already aware of from growing up with these games. If you want to try analyzing this data set for yourself (there are many other variables and relationships I didn't include), follow [this](https://github.com/StacheXC/MovesEDA) link to my repository that includes both the FULL data set along with the code I used to create the visuals in this blog post.