...
| name        |   accuracy |   pp |   priority |   power | damage_class.name   | generation.name   | target.name      | type.name   |
|:------------|-----------:|-----:|-----------:|--------:|:--------------------|:------------------|:-----------------|:------------|
| pound       |        100 |   35 |          0 |      40 | physical            | generation-i      | selected-pokemon | normal      |
| karate-chop |        100 |   25 |          0 |      50 | physical            | generation-i      | selected-pokemon | fighting    |
| double-slap |         85 |   10 |          0 |      15 | physical            | generation-i      | selected-pokemon | normal      |
| comet-punch |         85 |   15 |          0 |      18 | physical            | generation-i      | selected-pokemon | normal      |
| mega-punch  |         85 |   20 |          0 |      80 | physical            | generation-i      | selected-pokemon | normal      |

There are a total of 919 observations with 4 numerical features and 4 categorical ones. I'll go over each of them briefly.
...
```python
sns.countplot(data = moves, x = "damage_class.name")
plt.show()
```
